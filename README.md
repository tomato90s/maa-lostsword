...
| 副本扫荡 | ✅ 可用 | 自动扫荡黄金猎犬、经验书、属性石、巨石阵等副本 |
| 宝藏探索 | ✅ 可用 | 自动完成首页宝藏探索领取 |
| 公会 | ✅ 可用 | 自动完成公会签到、捐献和投资 |
| 好感 | ✅ 可用 | 自动完成角色好感对话 |
| 免费每日一抽 | ✅ 可用 | 自动完成每日免费召唤 |
| 个人突袭 | ✅ 可用 | 自动完成个人突袭领主扫荡 |
| 活动扫荡 | ✅ 可用 | 自动扫荡活动副本 |
| 商店 | 🚧 调试中 | 自动领取每日免费礼包，并处理交易所消耗品、突袭、公会、竞技场、夏日币等批量兑换 |
| 领取任务奖励 | ✅ 可用 | 自动领取每日/每周/史诗任务奖励（建议放到最后一个执行） |
